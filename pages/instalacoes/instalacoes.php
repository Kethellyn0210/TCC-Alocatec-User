...
<body>
    ...
    <div class="content">
        ...
        <div class="grid">
            <div class="card" onclick="window.location.href='../instalacao_part2/instalacoes.php?tipo_espaco=[Futebol]'"
                data-esporte="<?= htmlspecialchars($futebol) ?>">
                <img src="img/futebol.jpg">
                <div class="card-title">FUTEBOL</div>
            </div>

            <div class="card" onclick="window.location.href='../instalacao_part2/instalacoes.php?tipo_espaco=[Vôlei]'"
                data-esporte="<?= htmlspecialchars($volei) ?>">
                <img src="img/volei.jpg">
                <div class="card-title">VÔLEI</div>
            </div>

            <div class="card"
                onclick="window.location.href='../instalacao_part2/instalacoes.php?tipo_espaco=[Basquete]'"
                data-esporte="<?= htmlspecialchars($basquete) ?>">
                <img src="img/basquete.jpg">
                <div class="card-title">BASQUETE</div>
            </div>
        </div>

        <div class="grid">
            <div class="card" onclick="window.location.href='../instalacao_part2/instalacoes.php?tipo_espaco=[Piscina]'"
                data-esporte="<?= htmlspecialchars($piscina) ?>">
                <img src="img/piscina.jpg">
                <div class="card-title">PISCINAS</div>
            </div>

            <div class="card"
                onclick="window.location.href='../instalacao_part2/instalacoes.php?tipo_espaco=[Poliesportivo]'"
                data-esporte="<?= htmlspecialchars($poliesportivo) ?>">
                <img src="img/poli.jpg">
                <div class="card-title">POLIESPORTIVO</div>
            </div>

            <div class="card" onclick="window.location.href='../instalacao_part2/instalacoes.php?tipo_espaco=[Outros]'"
                data-esporte="<?= htmlspecialchars($outros) ?>">
